...
namespace Origine
{
    public struct StatusDescriptor
    {
        ...
        public static implicit operator StatusDescriptor(int code) => new StatusDescriptor { StatusCode = code };
        public static implicit operator int(StatusDescriptor code) => code.StatusCode;

        /// <summary>
        /// Status Code copy from <![CDATA[Microsoft.AspNetCore.Http.StatusCodes]]>
        /// </summary>
        #region StatusCodes 
